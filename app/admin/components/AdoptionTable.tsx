            ...
            <div className="hidden sm:block overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-orange-50">
                  {filtered.map((a) => {
                    const imgSrc = a.cat?.image_url ?? (a.cat as any)?.photos?.[0] ?? null;
                    return (
                      <tr key={a.id} className="hover:bg-orange-50/50 transition">
                        ...
                        <td className="px-5 py-4">
                          {a.cat ? (
                            <div className="flex items-center gap-2">
                              ...
                              {(a.cat as any).ficha && (
                                <span className="ml-2 inline-flex items-center px-1.5 py-0.5 rounded-md text-xs font-mono font-medium bg-orange-50 text-orange-600 border border-orange-200">
                                  #{(a.cat as any).ficha}
                                </span>
                              )}
                            </div>
                        ...
                        <td className="px-5 py-4 text-gray-600 text-xs whitespace-nowrap">
                          {parseLocalDate(a.adoption_date).toLocaleDateString(
                            "es-MX",
                            {
                              day: "2-digit",
                              month: "short",
