    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-wrap gap-4 mt-10 mx-auto justify-center">
          <a
            href="https://wa.me/526122891600"
            target="_blank"
            rel="noreferrer noopener"
            className="inline-flex items-center gap-3 bg-white hover:bg-gray-50 text-gray-900 font-bold text-sm px-6 py-3 rounded-xl shadow transition hover:scale-105 active:scale-95"
          >
            ...
            FERIAS DE ADOPCIÓN · 612 289 1600
          </a>

          <a
            href="https://wa.me/526121767890"
            target="_blank"
            rel="noreferrer noopener"
            className="inline-flex items-center gap-3 bg-white hover:bg-gray-50 text-gray-900 font-bold text-sm px-6 py-3 rounded-xl shadow transition hover:scale-105 active:scale-95"
          >
