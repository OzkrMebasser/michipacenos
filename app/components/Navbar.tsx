...
const NAV_LINKS = ['Nosotros', 'Adopción', 'Historias', 'Cómo ayudar', 'Blog', 'Contacto'];
      ...
      >
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
          ...
          <ul className="hidden lg:flex items-center gap-6">
            {NAV_LINKS.map(l => (
              <li key={l}>
                <a
                  href="#"
                  className="text-sm font-semibold text-gray-600 hover:text-pink-500 transition-colors relative group"
                >
                  {l}
                  <span className="absolute -bottom-0.5 left-0 w-0 h-0.5 bg-pink-400 group-hover:w-full transition-all duration-300 rounded-full" />
                </a>
              </li>
            ))}
          </ul>
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button className="bg-pink-500 hover:bg-pink-600 text-white font-bold px-5 py-2 rounded-full text-sm transition-all hover:scale-105 hover:shadow-lg shadow-pink-200 flex items-center gap-1.5">
              ❤️ Donar
            </button>
          </div>
        ...
        >
          <div className="bg-white border-t border-gray-100 px-4 py-4 flex flex-col gap-1">
            ...
            <div className="flex items-center gap-4 px-2 pt-2 pb-1">
              <a href="https://www.facebook.com/profile.php?id=61554151521513" target="_blank" rel="noreferrer noopener" className="text-blue-600" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
            ...
            <button className="bg-pink-500 hover:bg-pink-600 text-white font-bold py-2.5 rounded-full mt-1 transition-colors">
              ❤️ Donar ahora
            </button>
          </div>
        </div>
